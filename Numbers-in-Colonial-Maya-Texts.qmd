...
classifier_pattern <- paste(classifiers, collapse = "|")

# looking for classifier locations in 4_grams
number_4grams <- number_4grams |>
  mutate(
    c1 = str_detect(b1, classifier_pattern),
    c2 = str_detect(b2, classifier_pattern),
    c3 = str_detect(b3, classifier_pattern),
    c4 = str_detect(b4, classifier_pattern)
  )+
