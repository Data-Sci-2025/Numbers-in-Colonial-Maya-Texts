...
# eliminating incomplete chunks, [AND OTHER STUFF]
...
# [NOTE ANY ERRONEOUS DELETIONS HERE]
...
# also verifying there's a numeral in the gloss to help eliminate false positives
ebtun <- ebtun |>
  mutate(
    spanish_number =
      str_detect(breakdown, paste(esp_numbers, collapse = "|")) &
      str_detect(gloss, "[0-9]"),
