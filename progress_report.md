...
* I [extracted](data/ebtun_sample) and [read in](Numbers-in-Colonial-Maya-Texts.md#data-read-in) a much larger data set, now 200 pages of the original PDF, and rewrote the [row-cleaning](Numbers-in-Colonial-Maya-Texts.md#row-cleaning) chunk to eliminate all of the easily identified issues with the new data (I really can't emphasize enough how much work this was). My data is now in its final form.
